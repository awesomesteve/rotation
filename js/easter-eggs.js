/* js/easter-eggs.js — easter eggs, Tate quote rotator, sort pills, boot call
   Depends on: quotes.js (TATE_QUOTES, PHILOSOPHICAL_QUOTES), data.js, profiles.js */
(function initTateQuotes() {
  const quotes = TATE_QUOTES
